...
import it.emanu37429.atamcorse2.adapters.OfflineLineeAdapter;

public class FragmentOfflineLinee extends Fragment {


    public FragmentOfflineLinee() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        AsyncTask.execute(() -> {
            try {
                list = new ArrayList<>();
                JSONArray linee = new JSONArray(ClassU.StringFromResource(getContext(), R.raw.offlinelinee));
                ...
                getActivity().runOnUiThread(() -> {
                    ...
                    mRecyclerView.setAdapter(new OfflineLineeAdapter(list));
                });
            } catch (Exception e) {
                e.printStackTrace();
            }
