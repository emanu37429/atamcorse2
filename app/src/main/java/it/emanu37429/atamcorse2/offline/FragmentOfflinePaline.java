...
import it.emanu37429.atamcorse2.adapters.OfflineFermateAdapter;

public class FragmentOfflinePaline extends Fragment {


    public FragmentOfflinePaline() {
    }
        ...
        AsyncTask.execute(() -> {
            try {
                ...
                getActivity().runOnUiThread(() -> {
                    ...
                    final OfflineFermateAdapter adapter = new OfflineFermateAdapter(list);
