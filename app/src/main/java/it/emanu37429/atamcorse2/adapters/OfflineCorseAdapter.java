...
public class OfflineCorseAdapter  extends RecyclerView.Adapter<OfflineCorseAdapter.CorsaViewHolder> {
    private List<ClassU.Corsa> list;

    public OfflineCorseAdapter(List<ClassU.Corsa> list) {
        this.list = list;
    }
    ...
    public void onBindViewHolder(final CorsaViewHolder holder, int i) {
        ...
        View.OnClickListener listener = new View.OnClickListener() {
            ...
            public void onClick(final View view) {
                Intent i = new Intent(view.getContext(), OfflineGetCorsa.class);
                i.putExtra("id", linea.id);
