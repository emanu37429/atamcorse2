...
public class FermateAdapter extends RecyclerView.Adapter<FermateAdapter.FermateViewHolder> implements Filterable {
    private List<ClassU.Fermata> list;
    private List<ClassU.Fermata> lstall;

    public FermateAdapter(List<ClassU.Fermata> list) {
        this.list = list;
        lstall = list;
    }
    ...
    public void onBindViewHolder(final FermateViewHolder holder, int i) {
        ...
        holder.cd.setOnClickListener(view -> {
            Intent i1 = new Intent(holder.cd.getContext(), GetPalinaActivity.class);
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    for (ClassU.Fermata fermata : lstall) {
                        ...
                        if (fermata.nome.toLowerCase().contains(charString) || fermata.num.toLowerCase().contains(charString)) {
