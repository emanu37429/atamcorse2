...
import it.emanu37429.atamcorse2.offline.OfflineGetCorse;

public class OfflineLineeAdapter extends RecyclerView.Adapter<OfflineLineeAdapter.LineeViewHolder> {
    private List<ClassU.Linea> list;
    String id;

    public OfflineLineeAdapter(List<ClassU.Linea> list) {
        this.list = list;
    }
    ...
    public void onBindViewHolder(final LineeViewHolder holder, int i) {
        ...
        holder.cd.setOnClickListener(view -> {
            Intent i1 = new Intent(view.getContext(), OfflineGetCorse.class);
